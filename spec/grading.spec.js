...
describe('Grading Tests: ', function () {
  ...
  it('HTML includes the correct number of certain elements', function () {
    ...
    let headerElements =
      window.document.body.getElementsByTagName('Header').length;
    let footerElements =
      window.document.body.getElementsByTagName('Footer').length;
    let mainElements = window.document.body.getElementsByTagName('Main').length;
    let articleElements =
      window.document.body.getElementsByTagName('Article').length;
    let imageElements = window.document.body.getElementsByTagName('img').length;
  ...
  it('CSS body sets margin and display', function () {
    expect(window.getComputedStyle(window.document.body).display).toEqual(
      'block'
    );
